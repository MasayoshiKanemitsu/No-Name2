...
gulp.task("webpackJs",function(){
	return gulp
		.src(["src/asset/js/**/*.js", "!src/asset/js/old-ie/*.js", "!src/asset/js/dist/bundle.js", "!src/asset/js/page/**/*.js"])
		.pipe($.plumber())
		.pipe(webpackStream(webpackConfig, webpack))
		.pipe(gulp.dest("src/asset/js/dist/"))
...
gulp.task("uglify", function() {
	gulp.src(["src/asset/js/dist/bundle.js", "src/asset/js/page/**/*.js"])
		.pipe($.plumber())
		.pipe($.uglify())
		.pipe($.rename({
			extname: '.min.js'
...
gulp.task("watch", function () {
	...
	gulp.watch(["src/asset/js/**/*.js","!src/asset/js/old-ie/*.js","!src/asset/js/dist/bundle.js"],['webpackJs']);
	gulp.watch("src/asset/js/dist/bundle.js",['uglify']);
//	gulp.watch('src/asset/js/**/*.vue', ['webpackVue']);
//	gulp.watch('src/asset/js/**/*.js',['webpackMain']);
